...
2026-08-24 复核继续确认 JSONL/索引主从关系未变。新增 content kind/source 会随 message merge、truncate、fork 和 compaction 保留，thread tree archive 会关闭恢复出来的 descendants；恢复不再只重建文本，还要重建上下文来源与树形生命周期。
